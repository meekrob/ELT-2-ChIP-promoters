...
Sys.setenv(PROMOTOR_BED_PATH=PROMOTOR_BED_PATH, # all promoters
           ...
           IDR_BED = sprintf("ELT2_%s_combined.IDR.bed", params$stage), # peaks
           IDR_DF = sprintf("ELT2_%s_combined.IDR.df", params$stage), # peaks
...
set -ue # exit 1 if any vars are not set (above)
