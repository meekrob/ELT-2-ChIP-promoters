...
control_L3_v_L1_ashr <- lfcShrink(dds.GFPplusMinus, res=L3_v_L1, type = "ashr")
...
plotMA(control_L1_v_embryo_ashr, ylim = ylim, main = "control_L1_vs_embryo_ashr", alpha = 0.01)
plotMA(control_L3_v_embryo_ashr, ylim = ylim, main = "control_L3_vs_embryo_ashr", alpha = 0.01)
plotMA(control_L3_v_L1_ashr, ylim = ylim, main = "control_L3_vs_L1_ashr", alpha = 0.01)
