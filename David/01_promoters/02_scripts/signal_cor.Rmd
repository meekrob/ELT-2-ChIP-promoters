...
groups = smackdown %>% group_by(L1_int_exp) %>% summarize(SSR=sum(squares_regression), SSE=sum(squares_error), SST = SSR + SSE, RSQ = SSR/SST, n=n()) 
total = smackdown  %>% summarize(L1_int_exp="total", SSR=sum(squares_regression), SSE=sum(squares_error), SST = SSR + SSE, RSQ = SSR/SST, n=n()) 

summ = rbind(groups,total)
