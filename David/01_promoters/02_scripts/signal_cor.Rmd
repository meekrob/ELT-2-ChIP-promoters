...
dunn <- function(data, levels, method="bh")
{
  ...
  dunn.out$multCompLetters = data.frame(median=t(meds[names(letts)]),multCompLetter=letts)
  dunn.out
}
```
