...
motifProfile = function(granges.query) {
  ...
  granges.query$GGATAA = countOverlaps(granges.query, granges.GGATAA)
  granges.query$GGATAG = countOverlaps(granges.query, granges.GGATAG)
  granges.query$TGATAG = countOverlaps(granges.query, granges.TGATAG)
  granges.query
}
tmp = motifProfile(ELT2.bystage.masked$LE)
```
