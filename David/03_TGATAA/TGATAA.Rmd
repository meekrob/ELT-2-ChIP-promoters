...
K = do.call('rbind', k)
ggplot(K, aes(x=set,y=ave.TGATAA)) + geom_boxplot() + ggtitle("LE: Mean TGATAA across set", subtitle = "bootstrap distributions") + ylab("Mean TGATAA") + theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))+ ylim(c(0,1.5))
ggplot(K, aes(x=set,y=ave.set.w.TGATAA)) + geom_boxplot() + ggtitle("LE: Fraction of promoters w/ at least one TGATAA", subtitle = "bootstrap distributions") + ylab("fraction of promoters") + theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) + ylim(c(0.25,1))
...
K = do.call('rbind', k)
ggplot(K, aes(x=set,y=ave.TGATAA)) + geom_boxplot() + ggtitle("L1: Mean TGATAA across set", subtitle = "bootstrap distributions") + ylab("Mean TGATAA") + theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) + ylim(c(0,1.5))
ggplot(K, aes(x=set,y=ave.set.w.TGATAA)) + geom_boxplot() + ggtitle("L1: Fraction of promoters w/ at least one TGATAA", subtitle = "bootstrap distributions") + ylab("fraction of promoters") + theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) + ylim(c(0.25,1))
...
K = do.call('rbind', k)
ggplot(K, aes(x=set,y=ave.TGATAA)) + geom_boxplot() + ggtitle("L3: Mean TGATAA across set", subtitle = "bootstrap distributions") + ylab("Mean TGATAA") + theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))+ ylim(c(0,1.5))
ggplot(K, aes(x=set,y=ave.set.w.TGATAA)) + geom_boxplot() + ggtitle("L3: Fraction of promoters w/ at least one TGATAA", subtitle = "bootstrap distributions") + ylab("fraction of promoters") + theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) + ylim(c(0.25,1))
```
